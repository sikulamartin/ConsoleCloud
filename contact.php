...
// Získání dat přihlášeného uživatele (stejné jako na index.php)
...
<head>
    ...
    <title>Contact - ConsoleCloud</title>
...
<body>
    <div class="background-container">
        ...
        <header class="header-container" id="header">
            <div class="header container">
                <div class="header-wrapper">
                    ...
                    <ul class="header-links-wrapper">
                        ...
                        <li class="header-link"><a href="index.php">How it works</a></li>
            ...
            <div class="mobile-menu" id="mobileMenu">
                <nav class="mobile-nav-links">
                    <a href="index.php" class="mobile-link">How it works</a>
                    <a href="pricing.php" class="mobile-link">Pricing</a>
                    <a href="#" class="mobile-link">Dedicated servers</a>
                    <?php if ($prihlaseny_uzivatel): ?>
                            <li class="header-link"><a href="dashboard.php">Dashboard</a></li>
                    <?php endif; ?>
                </nav>
                <div class="mobile-actions">
                    <?php if ($prihlaseny_uzivatel): ?>
                        <a href="profile.php" class="btn btn-primary" style="display: flex; width: 100%; justify-content: center; background: transparent; border: 1px solid var(--clr-primary);">Dashboard</a>
        ...
        <div class="content">
            ...
            <section class="hero-container" style="min-height: auto;">
                <div class="info-box">
                    Contact us
                </div>
                <h2 class="hero-text">
                    Lets start a <span class="hero-gradient">conversation</span>
                </h2>
                <p class="hero-subtext">
                    Have questions about our servers, pricing, or just want to say hello?</br>
                    ...
                    <div class="contact-info-card">
                        <div class="contact-method">
                            ...
                            <div class="contact-details">
                                <h4>Email</h4>
                                <a href="mailto:support@consolecloud.com">support@consolecloud.com</a>
                            </div>
                        </div>
