...
// Načtení dat profilu
$stmt = $pdo->prepare("SELECT * FROM OSOBY WHERE id_osoba = ?");
$stmt->execute([$_SESSION['user_id']]);
$user = $stmt->fetch();

$zobrazene_jmeno = ($user['jmeno'] === 'Nezadáno') ? explode('@', $user['email'])[0] : htmlspecialchars($user['jmeno']);
?>
<!DOCTYPE html>
<html lang="cs">
<head>
    ...
    <title>My Profile - ConsoleCloud</title>
        ...
        <div class="content" style="margin-top: 140px;">
            <section class="container" style="max-width: 600px; margin-inline: auto;">
                ...
                <div class="contact-info-card">
                    ...
                    <form action="actions/update_profile.php" method="POST" class="contact-form">
