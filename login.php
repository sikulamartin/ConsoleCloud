...
<head>
    ...
    <title>ConsoleCloud - Sign In</title>
    ...
    <div class="auth-container">
        <div class="auth-left">
            <div class="auth-left-content">
                <h1 class="auth-title">
                    Explore all the<br>
                    <span class="highlight">greatest</span> titles
                </h1>
            </div>
        ...
        <div class="auth-right">
            <h2 class="auth-form-title"><span class="hero-gradient">Welcome </span>Back</h2>
            ...
            <form action="auth/login_process.php" method="POST">
                ...
                <div class="social-buttons">
                    <a href="auth/google_login.php" class="btn-social" style="text-decoration: none;">
